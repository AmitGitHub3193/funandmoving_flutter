...
import '../../SharedWidgets/AuthTextField.dart';
import '../../SharedWidgets/StaggerAnimation.dart';
...
class _LoginScreenState extends State<LoginScreen>
  ...
  void initState() {
    ...
    if (isDevelopmentMode) {
      email.text = "joshua+trainer@hayworthsoftware.com";
    ...
    if (email.text.isEmpty || password.text.isEmpty) {
      ...
      await services.login(
        ...
        if(value.authenticated==false){
          _failMessage("User or Password is incorrect", context);
        }
      });
      _stopAnimation();
    }
