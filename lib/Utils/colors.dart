...
const primary = Color(0xFF9FA6FF);
const secondary = Color(0xFF00B3BC);
const primaryDark = Color(0xFF12141D);

const textFieldBorderUnfocusedColor = Color(0xFF53535D);


/// basic colors
const kTeal50 = Color(0xFFE0F2F1);
const kTeal100 = Color(0xFF05628F);
...
const kTeal400 = Color(0xFF056270);
...
const kBackgroundAppBar = Color(0xFF056270);
...
var middleColor_light = Colors.black.withAlpha(128);
var middleColor_dark = Colors.white.withAlpha(128);
